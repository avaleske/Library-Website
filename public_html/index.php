...
<a href="book.php?bid=11"><img src='http://img52.imageshack.us/img52/2742/200pxhungergames.jpg' border='0'/></a>
...
Click "Catalog" to find out if what you're looking for is 
...
request the written work and we may have it available in the near future.
			...
			<h3>For Grading Purposes</h3>
				<p>
Either register a new user to browse the site as a standard user, or use the username 'valeskea' and the password 'Ada!L' to browse it as an admin. We recommend browsing the site while both logged in and logged out.
<br>
